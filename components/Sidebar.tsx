...
import { LayoutDashboard, BookOpen, BarChart2, Calendar, BrainCircuit, Upload, Settings, MessageSquare, Shield, Calculator } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <div className="w-64 h-screen bg-black border-r border-slate-900 flex flex-col fixed left-0 top-0 z-50">
